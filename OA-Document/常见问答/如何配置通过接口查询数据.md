...
手动输入：**手动输入请求地址从字段中获取**：从上级节点输出的字段中选择一个字段，该字段的数值作为请求地址
...
字段命名须符合命名规范，见
[附录->字段命名规范](https://site-admin.eteams.cn/help/1966020305649217439#%E5%C2%91%BD%E5%C2%90%8D%E8%A7%C2%84%E8%8C%C2%83)

**预览**

预览当前节点输出的数据。新生成一个condition字段用来接收Rest接口的返回结果：

![](https://dl.eteams.cn/site/cfd79b3f-8275-4f3d-b674-2f79ba38de88?imageType=png)